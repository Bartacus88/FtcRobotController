...
@Autonomous(name = "JK Auto Shoot and Line", group = "Pushbot")
//@Disabled
...
public class AutonomousCommand_Test_JK_20_21_Color_Crab extends LinearOpMode {
    ...
    AutoCommand cmd[] = {
            new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 8, 0.4, 0, 0, 6000),
//                             for SHOOT_RING State Value 1 = Shooter Power, Value 2 = Intake Power, Value 3 = Ring deflector Position.
            ...
            new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.CRABLEFT, 30, 0.4, 0, 0, 1000),
            new AutoCommand(AutonomousStates.AutoStates.SHOOT_RING, Drive.MoveType.REVERSE, .75, .85, 1.0, 0, 2000),
            new AutoCommand(AutonomousStates.AutoStates.MOVE_COLOR, Drive.MoveType.CRABLEFT, 15, 0.4, 0, 0, 1000),
