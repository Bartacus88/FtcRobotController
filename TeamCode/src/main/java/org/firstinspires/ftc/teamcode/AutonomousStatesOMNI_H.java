...
public class AutonomousStatesOMNI_H {
    ...
    public void runOpMode(LinearOpMode opMode, HardwareMap hardwareMap, AutoCommand cmd[]) {
        ...
        dParm.frontRight       = robot.motorRight;
        dParm.frontLeft        = robot.motorLeft;
        dParm.rearRight        = robot.motorRight;  //Should be unnecessary, but just keep the nulls away
        dParm.rearLeft         = robot.motorLeft;
        dParm.center           = robot.motorCenter;
        ...
        dParm.driveType        = Drive.DriveType.OMNI_H;
        dParm.imu              = robot.imu;
        dParm.motorRatio       = 28;
        dParm.gearRatio        = 19.2;
        ...
        dParm.minStartPower    = 0.15;
        dParm.minTurnPower     = 0.15;
        dParm.opMode           = opMode;
        dParm.debug            = true;
