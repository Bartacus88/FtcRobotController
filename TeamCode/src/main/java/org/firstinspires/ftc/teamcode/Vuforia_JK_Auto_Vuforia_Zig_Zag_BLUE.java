                        ...
                        if (tfod != null) {
                            ...
                            if (updatedRecognitions != null) {
                                ...
                                if (retRings == Rings2.FOUR) {
                                    cmd[3] = new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.CRABRIGHT, 10, 0.4, 12, 0, 1000);
                                    ...
                                    cmd[9] = new AutoCommand(AutonomousStates.AutoStates.MOVE_WOBBLE_ARM, Drive.MoveType.FORWARD, 0.1, 0, 0, 0, 500);
                                    //                            for MOVE_WOBBLE_ARM, State Value 1 = Wobble Arm Position.
                                    cmd[10] = new AutoCommand(AutonomousStates.AutoStates.MOVE_WOBBLE_ARM, Drive.MoveType.FORWARD, 0.11, 0, 0, 0, 500);
                                    cmd[11] = new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.REVERSE, 4, 0.4, 12, 0, 500);
                                    //cmd[12] = new AutoCommand(AutonomousStates.AutoStates.MOVE_CAMERA_X, Drive.MoveType.CRABLEFT, 25, 0.4, 18, 1, 4000);
                                    cmd[12] = new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.CRABLEFT, 25, 0.4, 18, 1, 4000);
                                    cmd[13] = new AutoCommand(AutonomousStates.AutoStates.MOVE_WOBBLE_ARM, Drive.MoveType.FORWARD, 0, 0, 0, 0, 500);
                                    ...
                                    //                            for MOVE_WOBBLE_ARM, State Value 1 = Wobble Arm Position.
                                    cmd[10] = new AutoCommand(AutonomousStates.AutoStates.MOVE_WOBBLE_ARM, Drive.MoveType.FORWARD, 0.11, 0, 0, 0, 500);
                                    cmd[11] = new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.FORWARD, 10, 0.4, 12, 0, 1000);
                                    cmd[12] = new AutoCommand(AutonomousStates.AutoStates.MOVE_WOBBLE_ARM, Drive.MoveType.FORWARD, 0, 0, 0, 0, 500);
