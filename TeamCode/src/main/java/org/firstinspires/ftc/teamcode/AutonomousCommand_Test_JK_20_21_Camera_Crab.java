...
@Autonomous(name = "JK Auto Vuforia drive to line", group = "Pushbot")
@Disabled
...
public class AutonomousCommand_Test_JK_20_21_Camera_Crab extends LinearOpMode {
    ...
    public void runOpMode() {
        cmd[0] = new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.REVERSE, 20, 0.3, 0, 0, 500);
        cmd[1] = new AutoCommand(AutonomousStates.AutoStates.MOVE_CAMERA_X, Drive.MoveType.CRABLEFT, 80, 0.3, 12, 0, 1000);
        cmd[2] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        cmd[3] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        cmd[4] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        cmd[5] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        cmd[6] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        cmd[7] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        cmd[8] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        //                            for MOVE_WOBBLE_ARM, State Value 1 = Wobble Arm Position.
        cmd[9] = new AutoCommand(AutonomousStates.AutoStates.WAIT, Drive.MoveType.STOP, 18, 0.4, 0, 0, 5000);
        //                            for MOVE_WOBBLE_ARM, State Value 1 = Wobble Arm Position.
