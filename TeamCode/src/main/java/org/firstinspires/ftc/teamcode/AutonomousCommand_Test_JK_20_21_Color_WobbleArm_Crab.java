...
public class AutonomousCommand_Test_JK_20_21_Color_WobbleArm_Crab extends LinearOpMode {
    ...
    AutoCommand cmd[] = {
            ...
            new AutoCommand(AutonomousStates.AutoStates.MOVE_WOBBLE_ARM, Drive.MoveType.REVERSE, 0.08, 0, 0, 0, 2000),
            //                            for MOVE_WOBBLE_ARM, State Value 1 = Wobble Arm Position.
            ...
            new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.CRABLEFT, 7, 0.4, 0, 0, 5000),
